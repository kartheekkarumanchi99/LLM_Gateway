...
const HOME: NavItem[] = [
  ...
  { label: 'Arbitrage', href: '/arbitrage', icon: Scale, badge: 'New' },
  ...
  { label: 'Dedup Cache', href: '/cache', icon: Database, badge: 'New' },
  ...
  { label: 'Replay', href: '/replay', icon: GitFork, badge: 'New' },
